...
import { TreeStructure, Plus, Trash } from '@phosphor-icons/react';
...
export interface ManagementSystemHeroEditorProps {
  id?: string;
  content: ManagementSystemHeroContent;
  onChange: (updated: ManagementSystemHeroContent) => void;
  errors?: Record<string, string>;
  errorPrefix?: string;
}

export const ManagementSystemHeroEditor: React.FC<ManagementSystemHeroEditorProps> = ({
  id = 'section-hero',
  content,
  onChange,
  errors = {},
  ...
  return (
    <CMSSectionCard
      id={id}
      title="Hero Section"
      subtitle="Header typography, multi-line heading stack and introductory narrative for Management System Certification"
      icon={TreeStructure}
      badge="Hero Banner"
    ...
    >
      <div className="space-y-6">
        ...
        <CMSTextarea
          ...
          optimalMax={240}
          required
          description="High-level narrative explaining accredited ISO management system audits and global compliance."
