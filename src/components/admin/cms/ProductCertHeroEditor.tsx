...
import type { ProductCertificationHeroContent } from '../../../cms/types';

export interface ProductCertHeroEditorProps {
  id?: string;
  content: ProductCertificationHeroContent;
  onChange: (updated: ProductCertificationHeroContent) => void;
  errors?: Record<string, string>;
  errorPrefix?: string;
}

export const ProductCertHeroEditor: React.FC<ProductCertHeroEditorProps> = ({
  id = 'section-hero',
  content,
  onChange,
  errors = {},
  ...
  return (
    <CMSSectionCard
      id={id}
      title="Hero Section"
      subtitle="Header typography, multi-line heading stack and introductory narrative"
      icon={Sparkle}
      badge="Hero Banner"
    ...
    >
      <div className="space-y-6">
        ...
        <CMSTextarea
          ...
          optimalMax={240}
          required
          description="High-level narrative explaining product conformity, CE marking and technical routes."
