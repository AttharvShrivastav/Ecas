...
export interface EsgHeroSectionEditorProps {
  content: ESGHeroContent;
  onChange: (updated: ESGHeroContent) => void;
  errors?: Record<string, string>;
}

export const EsgHeroSectionEditor: React.FC<EsgHeroSectionEditorProps> = ({
  content,
  onChange,
  errors = {},
}) => {
  ...
  return (
    <CMSSectionCard
      id="section-hero"
      title="Hero Section"
      subtitle="Public page header title and introductory narrative"
      icon={TextT}
      badge="Header"
      errorCount={errorCount}
    >
      <div className="space-y-6">
        {/* Heading Lines Controlled List */}
        <div>
              ...
              <div key={idx} className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <input
                    ...
                    placeholder={`e.g. ${idx === 0 ? 'ESG Assurance' : 'and Support'}`}
