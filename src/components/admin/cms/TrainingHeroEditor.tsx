...
export interface TrainingHeroEditorProps {
  id?: string;
  content: TrainingHeroContent;
  onChange: (updated: TrainingHeroContent) => void;
  errors?: Record<string, string>;
  errorPrefix?: string;
}

export const TrainingHeroEditor: React.FC<TrainingHeroEditorProps> = ({
  id = 'section-hero',
  content,
  onChange,
  errors = {},
  ...
  return (
    <CMSSectionCard
      id={id}
      title="Hero Section"
      subtitle="Header typography, multi-line heading stack and introductory narrative for Training & Academy"
      icon={GraduationCap}
      badge="Hero Banner"
    ...
    >
      <div className="space-y-6">
        ...
        <CMSTextarea
          ...
          optimalMax={240}
          required
          description="High-level narrative introducing the ECAS EURO Training & Academy educational programs."
